...
function getChartPalette(ctx, isDark, top, bottom) {
  const lineColor = isDark ? '#2ecc8f' : '#05704a';
  ...
  const upColor = isDark ? '#3fce90' : '#05704a';
  const downColor = isDark ? '#ff8f7a' : '#a82a19';
  const gradient = ctx.createLinearGradient(0, top, 0, bottom);
  gradient.addColorStop(0, isDark ? 'rgba(46,204,143,0.22)' : 'rgba(5,112,74,0.12)');
